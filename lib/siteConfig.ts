...
export const HERO_MEDIA: MediaType = {
  // Switch to { type: "video", src: "/videos/hero.mp4", poster: "/gallery/misc/manicure-cover.png" }
  // after you add public/videos/hero.mp4
  type: "image",
  src: "/gallery/misc/manicure-cover.png",
};
